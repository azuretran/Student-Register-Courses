...
urlpatterns = [
    ...
    path('check_code_exist_change_password/', HodViews.check_code_exist_change_password, name="check_code_exist_change_password"),
    ...
    path('staff_feedback_message_reply/', HodViews.staff_feedback_message_reply, name="staff_feedback_message_reply"),
     path('staff_feedback_gv_message/', HodViews.staff_feedback_gv_message, name="staff_feedback_gv_message"),
    path('staff_feedback_gv_message_reply/', HodViews.staff_feedback_gv_message_reply, name="staff_feedback_gv_message_reply"),
    ...
    path('manage_subject_teach/', StaffViews.manage_subject_teach, name="manage_subject_teach"),

    # URLS for Staff_gv
       path('staff_feedback_gv/', StaffGVView.staff_feedback_gv, name="staff_feedback_gv"),
    ...
    path('show_tkb_nhomTH_study', StaffGVView.show_tkb_nhomTH_study, name="show_tkb_nhomTH_study"),
    ...
    #price
    path('add_price_subject_gv/', StaffGVView.add_price_subject_gv, name="add_price_subject_gv"),
    path('add_price_subject_gv_save/', StaffGVView.add_price_subject_gv_save, name="add_price_subject_gv_save"),
    path('manage_subject_price_gv/', StaffGVView.manage_subject_price_gv, name="manage_subject_price_gv"),
    path('edit_subject_price_gv/<subject_id>/', StaffGVView.edit_subject_price_gv, name="edit_subject_price_gv"),
    path('edit_subject_price_gv_save/', StaffGVView.edit_subject_price_gv_save, name="edit_subject_price_gv_save"),
    path('delete_subject_price_gv/<subject_id>/', StaffGVView.delete_subject_price_gv, name="delete_subject_price_gv"),
    #room_service
    path('add_room_gv/', StaffGVView.add_room_gv, name="add_room_gv"),
    path('add_room_save/', StaffGVView.add_room_save, name="add_room_save"),
    path('manage_room_gv/', StaffGVView.manage_room_gv, name="manage_room_gv"),
    path('manage_room_gv_search/', StaffGVView.manage_room_gv_search, name="manage_room_gv_search"),

    path('edit_room_gv/<room_id>/', StaffGVView.edit_room_gv, name="edit_room_gv"),
    path('edit_room_gv_save/', StaffGVView.edit_room_gv_save, name="edit_room_gv_save"),
    path('delete_room_gv/<room_id>/', StaffGVView.delete_room_gv, name="delete_room_gv"),
    path('check_room_exist/', StaffGVView.check_room_exist, name="check_room_exist"),
     path('check_nhom_name_exist/', StaffGVView.check_nhom_name_exist, name="check_nhom_name_exist"),
     path('check_thuchanh_exist/', StaffGVView.check_thuchanh_exist, name="check_thuchanh_exist"),
     path('check_room_exist_together/', StaffGVView.check_room_exist_together, name="check_room_exist_together"),
    path('manage_sum_teach_teamplate/', StaffGVView.manage_sum_teach_teamplate, name="manage_sum_teach_teamplate"),
    path('manage_subject_teach_gv_hp/', StaffGVView.manage_subject_teach_gv_hp, name="manage_subject_teach_gv_hp"),
     path('manage_time_register_template/', StaffGVView.manage_time_register_template, name="manage_time_register_template"),
    path('add_time_register/', StaffGVView.add_time_register, name="add_time_register"),
    path('add_time_register_save/', StaffGVView.add_time_register_save, name="add_time_register_save"),
    path('edit_time_register/<time_id>/', StaffGVView.edit_time_register, name="edit_time_register"),
    path('edit_time_register_save/', StaffGVView.edit_time_register_save, name="edit_time_register_save"),
    path('delete_time_register/<time_id>/', StaffGVView.delete_time_register, name="delete_time_register"),
    path('check_session_day/', StaffGVView.check_session_day, name="check_session_day"),
    path('check_tkb_exist/', StaffGVView.check_tkb_exist, name="check_tkb_exist"),
    ...
    path('student_register/', StudentViews.student_register, name="student_register"),
    path('student_result_register/', StudentViews.student_result_register, name="student_result_register"),
    path('delete_dk_hp_study/<maTH>/', StudentViews.delete_dk_hp_study, name="delete_dk_hp_study"),
    path('check_subject_register_exist/', StudentViews.check_subject_register_exist, name="check_subject_register_exist"),
